...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Agu 2019 pada 17.21
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `resto_akses` (
...
CREATE TABLE IF NOT EXISTS `resto_contact` (
...
(1, 'ILHAM CAFE', 'Palembang', '+62813-99', 'Ilhamsetiawan920@gmail.com', 'www.com', '2019-04-30 07:53:05');
...
CREATE TABLE IF NOT EXISTS `resto_kategori` (
`kategori_id` int(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `resto_meja` (
...
CREATE TABLE IF NOT EXISTS `resto_meta` (
...
(1, 'Ilhamcafe | Untuk memenuhi syarat kerja', NULL, 'cafe', 'Ilham Setiyawan', 'Ilham Setiyawan', 'index, follow', 'index, follow', '2019-03-09 21:42:01');
...
CREATE TABLE IF NOT EXISTS `resto_order` (
...
(8, 10, 'ILHAM', '2019-08-26', 'asads', 4, 33, 0, 85000, 0, 0, NULL, 1, NULL, '2019-08-26 08:22:55'),
(9, 10, 'ILHAM', '2019-08-26', 'sadas', 2, 4, 0, 10000, 0, 0, NULL, 1, NULL, '2019-08-26 08:23:49');
...
CREATE TABLE IF NOT EXISTS `resto_order_detail` (
...
(25, 8, 11, 5000, 2, 1, 5000, 1, '2019-08-26 08:22:55'),
(26, 8, 5, 15000, 10, 1, 15000, 1, '2019-08-26 08:22:55'),
(27, 8, 7, 50000, 15, 1, 50000, 1, '2019-08-26 08:22:55'),
(28, 8, 1, 15000, 6, 1, 15000, 1, '2019-08-26 08:22:55'),
(29, 9, 14, 5000, 4, 2, 10000, 1, '2019-08-26 08:23:49');
...
CREATE TABLE IF NOT EXISTS `resto_slider` (
...
CREATE TABLE IF NOT EXISTS `resto_social` (
...
CREATE TABLE IF NOT EXISTS `resto_users` (
  `user_username` varchar(30) NOT NULL,
...
ALTER TABLE `resto_akses`
 ADD PRIMARY KEY (`akses_id`), ADD KEY `user_username` (`user_username`);
...
ALTER TABLE `resto_order`
 ADD PRIMARY KEY (`order_id`), ADD KEY `resto_order_ibfk_1` (`meja_id`);

--
-- Indexes for table `resto_order_detail`
--
ALTER TABLE `resto_order_detail`
 ADD PRIMARY KEY (`order_detail_id`), ADD KEY `resto_order_detail_ibfk_1` (`order_id`), ADD KEY `resto_order_detail_ibfk_2` (`menu_id`);
